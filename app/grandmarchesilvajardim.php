...
try {
	##FIREBIRD
	$con1 = new PDO('firebird:dbname=grandmarchesilvajardim.ddns.com.br/3050:/SDSuper/Dados/SDSuper.fdb', 'CONSULTORIA', 'CONSULTA321');
	...
	while ($row = $sql_stmt2->fetch()) {
		...
		##MYSQL
		$con2 = new PDO('mysql:host=cartazfacilpro.ctj8bnjcqdvd.us-east-2.rds.amazonaws.com;dbname=grandmarchesilvajardim', 'cartazdb', 'tbCJShR2');
